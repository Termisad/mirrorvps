...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://rgestdnyjrge.herokuapp.com/AgADML1035"
          alt="logo"
        />
        <a href="https://t.me/DrTorrentX">
          <h2 class="name">BitTorrent Client</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://www.github.com/TheCaduceus"><i class="fab fa-github"></i></a>
        <a href="https://t.me/DrTorrentX"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
@app.route('/')
def homepage():
    return "<h1><i>Bot is up & working!</i></h1>"
